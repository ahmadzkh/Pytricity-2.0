...
<html lang="en">
    <head>
        ...
        <script src="https://kit.fontawesome.com/9df4541ca6.js" crossorigin="anonymous"></script>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('assets/logo/recLongLogo.png') }}" alt="logo" height="30px"></a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            @if(isset(auth()->user()->username))
                                <a class="nav-link bg-primary text-white" href="{{ url('admin') }}">Dashboard</a>
                            @else
        ...
        <!-- main -->
        @php
            $profil = App\Models\User::where('id_user', 'USER0001')->first();
            // dd($profil->address[0]->kelurahan)
        @endphp
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        {{ $profil->address[0]->kelurahan }}, {{ $profil->address[0]->kecamatan }}, {{ $profil->address[0]->kota_kab }} {{ $profil->address[0]->kode_pos }}
                        <br><br>
                    </div>
                    <div class="col-sm-4">
